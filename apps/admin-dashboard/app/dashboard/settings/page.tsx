                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Enable grocery delivery services
                      </div>
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Enable package courier services
                      </div>
                    </div>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setFeatureFlags({ ...featureFlags, courierEnabled: checked })
                    }
                  />
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      Enable in-app wallet for users
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      Enable subscription plans for users
                    </div>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        Get notified for payment disputes
                      </div>
                    </div>
                  </div>
                  <Switch
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 border rounded-lg">
                  ...
                  <Input value="https://api.tatx.sa/webhooks" readOnly />
                </div>
              </CardContent>
            </Card>
          </TabsContent>

          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="flex flex-col items-center text-center space-y-10 mb-20">
              ...
              <div className="flex flex-wrap gap-6 justify-center pt-4">
                ...
                <div className="relative h-[60px] w-[200px] cursor-pointer hover:scale-105 transition-transform">
                  <Image src={googlePlayUrl} alt="Google Play" fill className="object-contain" />
                </div>
              </div>
            </div>
        ...
        <section className="py-40 relative overflow-hidden text-center bg-primary/5">
          <div className="container mx-auto px-4 max-w-5xl space-y-16">
            ...
            <div className="flex flex-wrap gap-8 justify-center pt-10">
              <div className="relative h-[80px] w-[240px] cursor-pointer hover:scale-105 transition-transform">
                <Image src={appStoreUrl} alt="App Store" fill className="object-contain" />
              </div>
              <div className="relative h-[80px] w-[260px] cursor-pointer hover:scale-105 transition-transform">
                <Image src={googlePlayUrl} alt="Google Play" fill className="object-contain" />
              </div>
            </div>
          </div>

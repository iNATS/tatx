...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 't2', providerId: 'toys-1', name: 'دبدوب هدية كبير', description: 'هادية لطيفة ومناسبة لكافة الأعمار', price: 85, image: 'https://picsum.photos/seed/teddy/400/400', category: 'toys', subCategory: 'هدايا' },
];
